...
from utils.embLoss import EmbLoss
...
class MACRIDVAE(GeneralRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.embedding_size = config.model_parameter.embeddingsize.value
        self.drop_out = config.model_parameter.dropout.value
        self.kfac = config.model_parameter.kfac.value
        self.tau = config.model_parameter.tau.value
        self.nogb = config.model_parameter.nogb.value
        self.anneal_cap = config.model_parameter.anneal_cap.value
        self.total_anneal_steps = config.model_parameter.anneal_steps.value
        self.regs = config.model_parameter.reg_weights.value
        self.std = config.model_parameter.std.value
